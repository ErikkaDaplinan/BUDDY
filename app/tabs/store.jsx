      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 60 }}> 
        ...
        <View className="p-4 mx-6 rounded-xl shadow-lg mb-4 bg-[#C2C2C2]"> 
          <View className="flex-column items-center justify-center p-5 mb-4"> 
            <Image 
              source={require('../../assets/images/cattoy.jpg')} 
        ...
        <View className="p-4 mx-6 rounded-xl shadow-lg mb-4 bg-[#C2C2C2]"> 
          <View className="flex-column items-center justify-center p-5 mb-4"> 
            <Image 
              source={require('../../assets/images/catfood.jpg')} 
              style={{ width: 200, height: 200 }} 
              resizeMode="contain" 
            /> 
            <View className="flex-1 mt-4 items-start"> 
        ...
        <View className="p-4 mx-6 rounded-xl shadow-lg mb-4 bg-[#C2C2C2]"> 
          <View className="flex-column items-center justify-center p-5 mb-4"> 
            <Image 
              source={require('../../assets/images/catleash.jpg')} 
              style={{ width: 200, height: 200 }} 
              resizeMode="contain" 
            /> 
            <View className="flex-1 mt-4 items-start"> 
        ...
        <View className="p-4 mx-6 rounded-xl shadow-lg mb-4 bg-[#C2C2C2]"> 
          <View className="flex-column items-center justify-center p-5 mb-4"> 
            <Image 
              source={require('../../assets/images/dogtoy.jpg')} 
              style={{ width: 200, height: 200 }} 
              resizeMode="contain" 
            /> 
            <View className="flex-1 mt-4 items-start"> 
        ...
        <View className="p-4 mx-6 rounded-xl shadow-lg mb-4 bg-[#C2C2C2]"> 
          <View className="flex-column items-center justify-center p-5 mb-4"> 
            <Image 
              source={require('../../assets/images/dogleash.jpg')} 
              style={{ width: 200, height: 200 }} 
              resizeMode="contain" 
            /> 
            <View className="flex-1 mt-4 items-start"> 
        ...
        <View className="p-4 mx-6 rounded-xl shadow-lg mb-4 bg-[#C2C2C2]"> 
          <View className="flex-column items-center justify-center p-5 mb-4"> 
            <Image 
              source={require('../../assets/images/dogfood.jpg')} 
              style={{ width: 200, height: 200 }} 
              resizeMode="contain" 
            /> 
            <View className="flex-1 mt-4 items-start"> 
